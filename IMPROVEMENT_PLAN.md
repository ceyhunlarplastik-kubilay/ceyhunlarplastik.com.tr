...
- Kalan Faz 1b yüzeyi: `(public)` — home (büyük, tek başına), urunler, ham-madde-sertifikalari, sepet + dinamik ürün/kategori sayfaları (DB içeriği çevrilmez, sadece chrome) + CustomerLeadDialog + auth ekranları + dil değiştirici UI (en son).
