...
- Kalan Faz 1b yüzeyi: `(public)` urunler + ham-madde-sertifikalari + sepet + dinamik ürün/kategori (DB içeriği çevrilmez, sadece chrome) + CustomerLeadDialog + auth ekranları + dil değiştirici UI (en son).
