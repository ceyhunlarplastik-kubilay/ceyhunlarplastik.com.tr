...
- **Faz 1b — public tamamlandı** 🎉 Kalan Faz 1b yüzeyi: dinamik ürün/kategori sayfaları (`urun/[slug]`, `urun-kategori/[slug]`, `urunler/filtre` — DB içeriği çevrilmez, sadece chrome/etiket) + CustomerLeadDialog + auth ekranları + dil değiştirici UI (en son).
