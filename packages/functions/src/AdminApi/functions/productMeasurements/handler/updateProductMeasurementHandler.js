...
export const updateProductMeasurementHandler = ({ productMeasurementRepository, productVariantRepository, measurementTypeRepository }) => {
    return async (event) => {
        ...
        try {
            ...
            if (!existing)
                throw new createError.NotFound("Measurement not found");
            if (body.variantId) {
            ...
            if (body.measurementTypeId) {
                ...
                if (!type)
                    throw new createError.NotFound("MeasurementType not found");
            }
