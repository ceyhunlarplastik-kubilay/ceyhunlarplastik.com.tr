...
export const updateAssetHandler = ({ assetRepository, categoryRepository, productRepository, productVariantRepository, productAttributeValueRepository }) => {
    return async (event) => {
        ...
        try {
            ...
            if (!existing)
                throw new createError.NotFound("Asset not found");
            if (body.categoryId) {
