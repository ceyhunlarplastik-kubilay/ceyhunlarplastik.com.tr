...
import { IMeasurementTypeDependencies, IDeleteMeasurementTypeEvent } from "@/functions/AdminApi/types/measurementTypes"

export const deleteMeasurementTypeHandler = ({ measurementTypeRepository }: IMeasurementTypeDependencies) => {
