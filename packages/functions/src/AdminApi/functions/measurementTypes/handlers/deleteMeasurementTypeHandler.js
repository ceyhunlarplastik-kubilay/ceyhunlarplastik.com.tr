...
export const deleteMeasurementTypeHandler = ({ measurementTypeRepository }) => {
    return async (event) => {
        ...
        try {
            ...
            if (err instanceof HttpError)
                throw err;
            if (err.code === "P2003")
                throw new createError.Conflict("Measurement type is used by products and cannot be deleted");
            console.error(err);
