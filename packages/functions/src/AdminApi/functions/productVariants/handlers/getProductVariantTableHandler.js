    ...
    return async (event) => {
        ...
        const optimizedData = result.data.map(variant => ({
            ...
            variantSuppliers: variant.variantSuppliers.map(vs => ({
                ...
                price: vs.price,
                operationalCostRate: vs.operationalCostRate,
                netCost: vs.netCost,
                profitRate: vs.profitRate,
                listPrice: vs.listPrice,
                paymentTermDays: vs.paymentTermDays,
                supplierVariantCode: vs.supplierVariantCode,
                supplierNote: vs.supplierNote,
                minOrderQty: vs.minOrderQty,
                stockQty: vs.stockQty,
                pricingUpdatedAt: vs.pricingUpdatedAt,
                availabilityUpdatedAt: vs.availabilityUpdatedAt,
