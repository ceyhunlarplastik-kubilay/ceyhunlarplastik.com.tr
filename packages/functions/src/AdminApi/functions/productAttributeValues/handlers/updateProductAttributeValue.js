...
export const updateProductAttributeValueHandler = ({ productAttributeValueRepository, assetRepository, }) => {
    return async (event) => {
        ...
        try {
            ...
            if (!current)
                throw new createError.NotFound("Value not found");
            ...
            if (hasParentValueInput) {
                if (requestedParentValueId) {
                    ...
                    if (current.attribute.code !== ATTRIBUTE_CODES.productionGroup &&
                ...
                else if (requestedParentValueId === null &&
