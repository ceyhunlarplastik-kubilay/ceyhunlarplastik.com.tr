...
import { listUsersHandler, getUserHandler, updateUserSupplierHandler, updateUserRoleHandler, } from "./handlers";
import { listUsersResponseValidator, getUserResponseValidator, idValidator, updateUserRoleResponseValidator, updateUserRoleValidator, updateUserSupplierValidator, updateUserSupplierResponseValidator, } from "@/functions/AdminApi/validators/users";
...
export const listUsers = lambdaHandler(async (event) => listUsersHandler({
...
export const updateUserSupplier = lambdaHandler(async (event) => updateUserSupplierHandler({
    userRepository: userRepository(),
...
export const updateUserRole = lambdaHandler(async (event) => updateUserRoleHandler({
