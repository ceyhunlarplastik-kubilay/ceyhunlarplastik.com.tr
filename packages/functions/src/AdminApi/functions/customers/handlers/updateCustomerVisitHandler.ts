...
import { ICustomerDependencies, IUpdateCustomerVisitEvent } from "@/functions/AdminApi/types/customers"

export const updateCustomerVisitHandler = ({ customerRepository }: ICustomerDependencies) => {
    return async (event: IUpdateCustomerVisitEvent) => {
