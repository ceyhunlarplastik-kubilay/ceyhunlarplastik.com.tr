...
import type {
    IAdminBusinessRequestDependencies,
...
export const listAdminBusinessRequestsHandler =
    ({ businessRequestRepository }: IAdminBusinessRequestDependencies) =>
        async (event: IListAdminBusinessRequestsEvent) => {
...
export const decideAdminBusinessRequestHandler =
    ({ businessRequestRepository }: IAdminBusinessRequestDependencies) =>
        async (event: IDecideAdminBusinessRequestEvent) => {
