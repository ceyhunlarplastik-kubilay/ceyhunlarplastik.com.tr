...
export const updateCategoryHandler = ({ categoryRepository, assetRepository, }) => {
    return async (event) => {
        ...
        const allowedFields = ["name", "allowedAttributeValueIds", "assetType", "assetRole", "assetKey", "mimeType"];
        ...
        try {
            ...
            console.error(err);
            throw new createError.InternalServerError("Failed to update category");
        }
    };
};
