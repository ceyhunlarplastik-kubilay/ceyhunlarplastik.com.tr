...
const businessRequestDomainValues = ["SALES", "PURCHASING"];
...
const businessRequestPriorityValues = ["LOW", "NORMAL", "HIGH", "URGENT"];
const approvalRoleValues = ["CUSTOMER", "SUPPLIER", "SALES", "SALES_DIRECTOR", "PURCHASING", "ADMIN", "OWNER"];
const approvalStepStatusValues = ["PENDING", "APPROVED", "REJECTED", "SKIPPED"];
...
export const businessRequestResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const businessRequestDecisionResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const businessRequestListResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const createPortalBusinessRequestValidator = validatorWrapper(z.object({
    body: z.object({
        type: z.enum([
            "CUSTOMER_PROFILE_CHANGE",
            "CUSTOMER_ORDER_REQUEST",
...
export const listBusinessRequestsValidator = validatorWrapper(z.object({
...
export const decideBusinessRequestValidator = validatorWrapper(z.object({
