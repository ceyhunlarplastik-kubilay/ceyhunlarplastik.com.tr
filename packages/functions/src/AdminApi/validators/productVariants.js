...
export const createProductVariantValidator = validatorWrapper(z.object({
    body: z.object({
        productId: z.uuid(),
...
export const updateProductVariantValidator = validatorWrapper(z.object({
...
export const productVariantResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const listProductVariantResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
