...
export const createProductAttributeValueValidator = validatorWrapper(z.object({
    body: z.object({
        name: z.string().min(1),
        attributeId: z.uuid(),
...
export const updateProductAttributeValueValidator = validatorWrapper(z.object({
...
export const createProductAttributeValueAssetUploadValidator = validatorWrapper(z.object({
    body: z.object({
