...
export const createMeasurementTypeValidator = validatorWrapper(z.object({
    body: z.object({
...
export const updateMeasurementTypeValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
// Response Validators
export const measurementTypeResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const listMeasurementTypeResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
