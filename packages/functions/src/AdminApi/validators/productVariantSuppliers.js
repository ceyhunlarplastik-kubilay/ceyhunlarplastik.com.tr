...
export const createProductVariantSupplierValidator = validatorWrapper(z.object({
    body: z.object({
        variantId: z.uuid(),
        supplierId: z.uuid(),
...
export const updateProductVariantSupplierValidator = validatorWrapper(z.object({
...
export const productVariantSupplierResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const bulkUpdateProductVariantSupplierPricingValidator = validatorWrapper(z.object({
    body: z.object({
        productId: z.uuid(),
        supplierId: z.uuid().optional(),
        operationalCostRate: z.number().min(0).max(1000).optional(),
...
export const listProductVariantSuppliersResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const listSupplierProductsResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
