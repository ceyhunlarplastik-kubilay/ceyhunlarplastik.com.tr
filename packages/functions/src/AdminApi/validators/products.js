...
/* ===========================
   REQUEST VALIDATORS
=========================== */
export const createProductValidator = validatorWrapper(z.object({
    body: z.object({
        code: z.string().min(1),
        name: z.string().min(1),
...
export const updateProductValidator = validatorWrapper(z.object({
...
export const createProductAssetUploadValidator = validatorWrapper(z.object({
    body: z.object({
