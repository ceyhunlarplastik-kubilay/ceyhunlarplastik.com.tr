...
export const decideSupplierApprovalRequestValidator = validatorWrapper(
    z.object({
...
export const decideSupplierApprovalRequestResponseValidator = z.toJSONSchema(
    z.object({
        statusCode: z.number(),
        body: z.object({
            statusCode: z.number(),
            payload: z.object({
                accepted: z.boolean(),
                approvalRequest: approvalRequestSchema.nullable().optional(),
            }),
        }),
    }).loose()
)
