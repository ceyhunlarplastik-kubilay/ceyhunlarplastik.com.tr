...
export const createSupplierValidator = validatorWrapper(z.object({
    body: z.object({
...
export const getSupplierValidator = validatorWrapper(z.object({
...
export const deleteSupplierValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
}), {
...
export const updateSupplierValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const supplierResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const listSuppliersResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
