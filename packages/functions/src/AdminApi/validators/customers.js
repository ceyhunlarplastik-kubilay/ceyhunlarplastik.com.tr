...
export const customerIdValidator = validatorWrapper(z.object({
...
export const customerVisitIdValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
        visitId: z.uuid(),
    }),
...
export const updateCustomerValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const replaceCustomerFeaturedProductsValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const replaceCustomerAssignedProductsValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const createCustomerVisitValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const updateCustomerVisitValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
        visitId: z.uuid(),
    }),
...
export const listCustomersResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const customerResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const customerFeaturedProductsResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const customerAssignedProductsResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const customerVisitsResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const customerVisitResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
