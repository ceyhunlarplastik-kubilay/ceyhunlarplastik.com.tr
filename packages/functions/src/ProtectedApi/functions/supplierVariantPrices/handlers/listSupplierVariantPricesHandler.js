...
const ALLOWED_SORT_FIELDS = ["updatedAt", "createdAt", "pricingUpdatedAt"];
export const listSupplierVariantPricesHandler = ({ productVariantSupplierRepository }) => async (event) => {
    ...
    const supplierIdFilter = user.supplierId ??
