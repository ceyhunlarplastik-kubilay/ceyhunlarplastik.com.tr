...
export const updateSupplierProfileValidator = validatorWrapper(z.object({
    body: z.object({
...
export const updateSupplierVariantPriceValidator = validatorWrapper(z.object({
    pathParameters: z.object({
        id: z.uuid(),
    }),
    body: z.object({
...
export const supplierVariantPriceResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const supplierProfileResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
...
export const listSupplierVariantPricesResponseValidator = z.toJSONSchema(z.object({
    statusCode: z.number(),
    body: z.object({
        statusCode: z.number(),
        payload: z.object({
