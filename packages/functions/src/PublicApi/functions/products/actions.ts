...
import { listProductsHandler, getProductHandler, getProductBySlugHandler, getProductVariantTableHandler, getProductVariantsByMeasurementHandler } from "@/functions/PublicApi/functions/products/handlers"
import { idValidator, slugValidator, listProductsResponseValidator, productResponseValidator, productVariantTableResponseValidator, productVariantTableRequestValidator, productVariantsByMeasurementRequestValidator, productVariantsByMeasurementResponseValidator } from "@/functions/PublicApi/validators/products"
import type { IListProductsEvent, IGetProductEvent, IGetProductBySlugEvent, IGetProductVariantTableEvent, IGetProductVariantsByMeasurementEvent } from "@/functions/PublicApi/types/products"
...
export const getProductVariantsByMeasurement = lambdaHandler(
    async (event) =>
        getProductVariantsByMeasurementHandler({
            productVariantRepository: productVariantRepository(),
        })(event as IGetProductVariantsByMeasurementEvent),
    {
        auth: false,
        requestValidator: productVariantsByMeasurementRequestValidator,
        responseValidator: productVariantsByMeasurementResponseValidator,
    }
)
