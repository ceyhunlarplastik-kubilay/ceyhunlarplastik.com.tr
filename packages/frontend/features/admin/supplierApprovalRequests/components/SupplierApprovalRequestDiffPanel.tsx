...
type Props = {
    request: AdminSupplierApprovalRequest
    currentSnapshot?: JsonRecord | null
    requestedPayload?: JsonRecord | null
    showAllFields: boolean
    onToggleShowAll: () => void
}

function getProductPreview(request: AdminSupplierApprovalRequest) {
...
export function SupplierApprovalRequestDiffPanel({
    request,
    currentSnapshot,
    requestedPayload,
    showAllFields,
    ...
    return (
        <div className="mx-auto max-w-none space-y-3 rounded-2xl border border-neutral-200 bg-neutral-50/70 p-3">
            ...
            {request.type === "VARIANT_PRICING_UPDATE" && productPreview ? (
