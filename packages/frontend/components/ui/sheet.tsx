...
/**
 * shadcn kaynağından BİLİNÇLİ SAPMA: fiziksel yön yardımcıları (panelin
 * yaslandığı kenar, kenarlık ve kapatma düğmesinin konumu) mantıksal
 * karşılıklarıyla değiştirildi. Repo Arapça yayınlıyor ve
 * `components/logicalProperties.test.ts` bu klasörü kapıda tutuyor; LTR'de
 * render birebir aynıdır. `npx shadcn add … --overwrite` bunu geri alırsa
 * test düşer.
 */
